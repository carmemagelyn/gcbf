<template>
  <div class="login-page min-vh-100 d-flex">
    <div class="row g-0 w-100">
      ...
      <div class="col-lg-6 d-flex align-items-center justify-content-center text-white" style="background-color: #9A3F3F;">
        <div class="p-5 text-center">
          ...
          <p class="lead">Sign in to continue your journey with GCBF</p>
          <p class="mt-4">Join us in worship, fellowship, and growing in God's grace together.</p>
        </div>
      </div>
