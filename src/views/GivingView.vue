...
const loadGifts = () => {
  ...
  if (savedGifts) {
    ...
    // Add sample gifts to demonstrate the new payment schedule process
    gifts.value = [
      {
        id: '1',
        amount: 1000,
        ...
        payments: [
          {
            ...
            receiptFile: null,
            receiptFileName: 'gcash-oct-2024.jpg',
          ...
          },
          {
            ...
            receiptFileName: '',
            receiptUrl: '',
            referenceNumber: 'CASH-REF-NOV-001',
            verificationStatus: 'pending',
            verifiedBy: null,
            verifiedDate: null,
            notes: 'Paid in cash after service'
          },
          {
            id: 'payment_1_3',
            dueDate: '2024-12-01',
      ...
      },
      {
        ...
        duration: 2, // 2 months = ~8 weekly payments
        notes: 'Weekly offering for youth ministry',
        status: 'active',
        ...
        payments: [
          {
            ...
            paymentMethod: 'online',
            receiptFile: null,
            receiptFileName: 'paymaya-week1.jpg',
            receiptUrl: 'data:image/jpeg;base64,sample',
            referenceNumber: '',
            verificationStatus: 'approved',
            verifiedBy: 'Pastor John Louie Berdejo',
